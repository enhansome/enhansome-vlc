...
* [vlc-pause-click-plugin](https://github.com/nurupo/vlc-pause-click-plugin) ⭐ 1,200 | 🐛 19 | 🌐 C | 📅 2025-01-28 - Plugin for VLC that pauses/plays video on mouse click.
* [vlc-bittorrent](https://github.com/johang/vlc-bittorrent) ⭐ 497 | 🐛 9 | 🌐 C++ | 📅 2026-08-09 - A bittorrent plugin for VLC.
* [vlc-win10smtc](https://github.com/spmn/vlc-win10smtc) ⭐ 126 | 🐛 2 | 🌐 C++ | 📅 2026-08-26 - Plugin that integrates VLC Media Player with Windows 10 System Media Transport Controls (SMTC).
...
* [vlc-mixer](https://github.com/lachie/vlc-mixer) ⭐ 3 | 🐛 0 | 🌐 Zig | 📅 2021-07-01 - Audio mixer VLC plugin written in Zig.
...
* [vlcj](https://github.com/caprica/vlcj) ⭐ 1,240 | 🐛 5 | 🌐 Java | 📅 2026-02-22 -  Java framework for the vlc media player (desktop).
...
* [python-vlc](https://github.com/oaubert/python-vlc) ⭐ 447 | 🐛 96 | 🌐 Python | 📅 2025-06-09 - Python vlc bindings.
