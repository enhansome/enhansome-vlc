...
* [vlc-win10smtc](https://github.com/spmn/vlc-win10smtc) ⭐ 134 | 🐛 2 | 🌐 C++ | 📅 2026-08-26 - Plugin that integrates VLC Media Player with Windows 10 System Media Transport Controls (SMTC).
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,809 | 🐛 5 | 🌐 C# | 📅 2026-08-31 - Cross-platform .NET/Mono bindings for LibVLC.
* [vlcj](https://github.com/caprica/vlcj) ⭐ 1,241 | 🐛 7 | 🌐 Java | 📅 2026-02-22 -  Java framework for the vlc media player (desktop).
...
* [python-vlc](https://github.com/oaubert/python-vlc) ⭐ 445 | 🐛 96 | 🌐 Python | 📅 2026-09-07 - Python vlc bindings.
