...
* [vlc-delete](https://github.com/surrim/vlc-delete) ⭐ 117 | 🐛 7 | 🌐 Lua | 📅 2026-06-19 - VLC extension to remove videos from the hard disk.
...
* [vlc-auto-dir-enqueue-prev-next](https://github.com/eltoro0815/vlc-auto-dir-enqueue-prev-next) ⭐ 6 | 🐛 1 | 🌐 Lua | 📅 2025-09-19 - Automatically adds the previous and next track from the same directory to the VLC playlist as soon as a file starts playing.
