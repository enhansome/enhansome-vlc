...
* [vlc-win10smtc](https://github.com/spmn/vlc-win10smtc) ⭐ 134 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - Plugin that integrates VLC Media Player with Windows 10 System Media Transport Controls (SMTC).
...
* [vlcj](https://github.com/caprica/vlcj) ⭐ 1,242 | 🐛 9 | 🌐 Java | 📅 2026-02-22 -  Java framework for the vlc media player (desktop).
...
* [python-vlc](https://github.com/oaubert/python-vlc) ⭐ 445 | 🐛 94 | 🌐 Python | 📅 2026-09-10 - Python vlc bindings.
